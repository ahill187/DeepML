...
allKeys=[]
modelData=[]
modelList=[x for x in sys.argv[1].split(',') if len(x)>0]
for model in modelList:
    data=None
    fname='%s/model/full_info.log'%model
