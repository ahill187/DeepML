...
def meanpquantilesDNN(Inputs,nclasses,nregclasses,dropoutRate=None,batchNorm=True,splitInputs=False,pfix='',arch=':32x16x4'):
...
def semiParamDNN(Inputs,nclasses,nregclasses,dropoutRate=None,batchNorm=True,splitInputs=False,pfix='',arch=':32x16x4'):
